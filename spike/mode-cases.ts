...
import { advancedSupported, readMode, settingsPath, writeMode } from '../apps/desktop/src/main/mode.ts'
...
writeFileSync(file, 'other-namespace:\n  keep: true\ndsh-desktop:\n  mode: compatibility\ntrailing:\n  keep: 1\n')
writeMode(home, 'advanced')
const preserved = readRaw()
check('foreign sections preserved', preserved.includes('other-namespace:') && preserved.includes('trailing:') && preserved.includes('keep: true'))
